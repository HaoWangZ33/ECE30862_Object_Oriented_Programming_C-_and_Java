...
public class ResourceManager {
    ...
    private Sprite creaturefireSprite;
    
    
    public Sprite getFire(){
    	return fireSprite;
    }
    public Sprite getcreaturefireSprite(){
    	return creaturefireSprite;
    }
    ...
    */
    ...
    public TileMap loadcustomMap(){
    	...
    	while (map == null){
    		try{
    			...
    			System.out.println("Invalid filename! Reenter filename:");
    			map = null;
    		}
    	}
    ...
    private void loadPowerUpSprites() {
        ...
        // create "star" sprite
        anim = new Animation();
        anim.addFrame(loadImage("star1.png"), 150);
        Animation anim1 = new Animation();
        anim1.addFrame(loadImage("star2.png"), 150);
        Animation anim2 = new Animation();
        anim1.addFrame(loadImage("star3.png"), 150);
        Animation anim3 = new Animation();
        anim1.addFrame(loadImage("star4.png"), 150);
        coinSprite = new Star(anim, anim1, anim2, anim3);
        ...
        mushroom = new PowerUp.Mushroom(anim);
        
        // create explode sprite
        anim = new Animation();
        anim.addFrame(loadImage("explode.png"), 150);
        ...
        //create "fire" sprite
        anim = new Animation();
        anim.addFrame(loadImage("shoot1.png"), 150);
        Animation anim_new = new Animation();
        anim_new.addFrame(loadImage("shoot1.png"), 150);
        fireSprite = new Fire(anim,anim_new,anim,anim_new);
        
        //create "creaturefire" sprite
        anim = new Animation();
        anim.addFrame(loadImage("shoot1.png"), 150);
        anim_new = new Animation();
        anim_new.addFrame(loadImage("shoot1.png"), 150);
        creaturefireSprite = new CreatureFire(anim_new,anim,anim_new,anim);
    }
